  ...
  const enrichContacts = async () => {
    ...
    try {
      ...
      if (data?.company) {
        setCompany((prev) => ({
          ...prev,
          industry: data.company.industry || prev?.industry || null,
          hq_city: data.company.hqCity || prev?.hq_city || null,
          hq_country: data.company.hqCountry || prev?.hq_country || null,
          domain: data.company.domain || prev?.domain || null,
          employee_count: data.company.size || prev?.employee_count || null,
          confidence: data.company.confidence ?? prev?.confidence,
        }));
      }
