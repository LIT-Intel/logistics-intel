export const SYN = {
  ...
  lanes: {
    ...
    origin_port: ['pol', 'port of loading', 'origin port'],
    ...
    dest_port: ['pod', 'port of discharge', 'destination port'],
  ...
  rates: {
    charge_name: ['charge', 'surcharge', 'fee', 'component', 'line item'],
    uom: ['uom', 'per', 'unit', 'basis', 'calc basis'],
    rate: ['rate', 'amount', 'price', 'cost'],
    min: ['min', 'minimum'],
    currency: ['currency', 'cur'],
    container_type: ['container', 'equipment', 'cntr'],
    origin_port: ['origin port', 'pol'],
    dest_port: ['destination port', 'pod'],
