export const SYN = {
  ...
  lanes: {
    ...
    service_level: ['service level', 'service', 'tier', 'service type', 'direct', 'tranship'],
    equipment: ['equipment', 'container', 'cntr type', 'uld', 'equipment size', 'cntr size'],
    weight_kg: ['weight', 'kg', 'avg kg', 'chargeable kg', 'base per kg'],
    volume_cbm: ['cbm', 'volume', 'm3', 'avg cbm'],
    shipments_per_year: ['shipments per year', 'annual shipments', 'frequency', 'per year', 'py', 'forecasted volume', 'forecast volume'],
  },
  rates: {
