/**
 * Supabase Client Re-export & Utility Functions
 *
 * This file re-exports the shared Supabase client from supabaseAuthClient.ts
 * to ensure only ONE client instance is created across the entire app.
 *
 * All files should import from this location:
 *   import { supabase } from '@/lib/supabase'
 *
 * This prevents "Multiple GoTrueClient instances detected" errors and ensures
 * consistent authentication state across billing functions, edge function calls, etc.
 */

export { supabase, isSupabaseAvailable, getSupabaseError } from '../auth/supabaseAuthClient';
import { supabase, getSupabaseError } from '../auth/supabaseAuthClient';

// Helper to check if Supabase is available (for backwards compatibility)
