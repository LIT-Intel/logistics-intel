...
export const COUNTRY_COORDS: Record<string, [number, number]> = {
  ...
  // 2026-09-11 — world-map completion. Central America + the Caribbean were
  // entirely absent, so produce/apparel lanes ("La Ceiba, Honduras → US",
  // Dole repro) resolved to NOTHING and the profile hero map drew zero arcs
  // while counting every row "unresolved". Russia, the Baltics, most of
  // Africa and the Gulf were missing too. Coords are country centroids
  // [lng, lat], same convention as above.
  honduras: [-86.6, 14.8],
  guatemala: [-90.2, 15.8],
...
export const ENDPOINT_ALIAS_MAP: Record<string, string> = {
  ...
  "south carolina": "usa",
  "north carolina": "usa",
  // 2026-09-11 — name variants + key port cities for the world-map
  // completion block ("Georgia" the country is intentionally omitted:
  // it collides with the US state, which is the overwhelmingly more
  // common meaning in US-import lane data).
...
export const LOCODE_PREFIX_MAP: Record<string, string> = {
  ...
  NZ: "new zealand",
  // 2026-09-11 — codes for the world-map completion block (flags + LOCODE
  // prefix resolution for the new countries).
  HN: "honduras",
  GT: "guatemala",
  SV: "el salvador",
  NI: "nicaragua",
...
const COUNTRY_DISPLAY_NAMES: Record<string, string> = {
  ...
  laos: "Laos",
  "new zealand": "New Zealand",
  // 2026-09-11 — display names for the world-map completion block.
  honduras: "Honduras",
  guatemala: "Guatemala",
