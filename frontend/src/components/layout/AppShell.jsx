  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="flex min-h-screen">
        ...
        >
          <div
            className={`flex items-center ${collapsed ? "justify-center" : ""} px-3 py-4 border-b border-white/10`}
          >
          ...
          <nav className="mb-6">
            <SideLink
              to="/app/admin"
              icon={Shield}
              label={collapsed ? "" : "Admin Dashboard"}
            />
            <SideLink
              to="/app/prospecting"
              icon={TrendingUp}
              label={collapsed ? "" : "Lead Prospecting"}
            />
