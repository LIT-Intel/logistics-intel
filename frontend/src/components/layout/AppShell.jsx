  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="flex min-h-screen">
        <aside className={`${collapsed ? 'w-16' : 'w-64'} transition-all duration-200 shrink-0 bg-gradient-to-b from-slate-800 via-slate-700 to-slate-900 shadow-2xl hidden md:flex md:flex-col`}>
          <div className={`flex items-center ${collapsed ? 'justify-center' : ''} px-3 py-4 border-b border-white/10`}>
          ...
          {!collapsed && <div className="px-4 py-2 text-gray-400 text-xs font-semibold uppercase tracking-wider">Menu</div>}
          <nav className="mb-4">
          ...
          {!collapsed && <div className="px-4 py-2 text-gray-400 text-xs font-semibold uppercase tracking-wider">Admin</div>}
          <nav className="mb-6">
        ...
        <main className="flex-1 min-w-0 flex flex-col">
          <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-14 flex items-center justify-between px-4">
            <div className="flex items-center gap-3 min-w-0">
              <button className="hidden md:inline-flex p-2 rounded-lg border text-gray-600" onClick={() => setCollapsed(c => !c)} aria-label="Toggle menu">
                ≡
              </button>
