...
export const SEQUENCES: Record<SequenceKey, SequenceStep[]> = {
  "trial-welcome": [
    ...
    },
    {
      ...
      subject: "Your free searches expire in 2 days",
      purpose: "Trial reminder + value recap (7-day trial)",
    },
    {
      step: 4,
      delayHours: 144,
      ...
      purpose: "Demo nudge before trial expiry (day 6)",
    },
    {
      step: 5,
      delayHours: 168,
      ...
      purpose: "Trial recap + upgrade CTA (day 7)",
    },
  ],
  "top-100-followup": [
    {
