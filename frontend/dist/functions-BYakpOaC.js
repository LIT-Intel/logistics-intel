import{K as O,M as E,N as R,O as L,P as I,Q as U,T as x,U as F,V as $,W as M,X as b,Y as G,Z as H,$ as J}from"./index-G9C_8T3I.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ce(e=O(),t=T){const n=R(E(e),N).getImmediate({identifier:t}),s=L("functions");return s&&ue(n,...s),n}function ue(e,t,r){W(E(e),t,r)}function le(e,t,r){return z(E(e),t)}ae();const de={apiKey:"AIzaSyCHh99l2qi5XQHeWV0fh8FSGHriiIraT7s",authDomain:"logistics-intel.firebaseapp.com",projectId:"logistics-intel",storageBucket:"logistics-intel.firebasestorage.app",messagingSenderId:"187580267283",appId:"1:187580267283:web:9c6bc974f7048a96b178e6",measurementId:"G-BG53DJBNDP"},fe=H().length?O():J(de),pe=ce(fe,"us-central1"),f=(e,t)=>async r=>{try{const s=await le(pe,e)(r??{});return s==null?void 0:s.data}catch{return typeof t=="function"?t(r):t}},ye=f("generateRfpPdf",{ok:!1}),ke=f("createStripePortalSession",{ok:!1}),we=f("sendEmail",{ok:!1,message:"Email not yet wired"}),Ae=f("phantombusterLinkedIn",{ok:!1,message:"Disabled"}),Te=f("searchLeads",{ok:!0,results:[],total:0}),Ee=f("toggleCompanySave",{ok:!0,saved:!1}),Ne=f("debugAgent",{ok:!1}),be=f("litPing",{ok:!0,ts:Date.now(),uid:null}),Se=f("getCompanyOverview",{totals:{shipments:0,spendUSD:0,lanes:0,carriers:0},trend:[],byMode:[]}),Ce=f("getCompanyShipments",{rows:[],total:0}),me=f("company_save",{ok:!1}),ve=me,he=f("ai_enrichCompany",{ok:!1}),Oe=he;export{Ce as a,we as b,ye as c,ke as d,Oe as e,Te as f,Se as g,Ne as h,be as l,Ae as p,ve as s,Ee as t};
