import{X as I,Y as E,Z as R,$ as L,a0 as O,a1 as U,a2 as x,a3 as F,a4 as $,a5 as M,a6 as b,a7 as G,a8 as H,a9 as J}from"./main-CNsx_jBw.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const se="auth-internal",ie="app-check-internal",oe="messaging-internal";function ae(e){const t=(r,{instanceIdentifier:n})=>{const s=r.getProvider("app").getImmediate(),o=r.getProvider(se),a=r.getProvider(oe),i=r.getProvider(ie);return new K(s,o,a,i,n)};$(new M(N,t,"PUBLIC").setMultipleInstances(!0)),b(C,v,e),b(C,v,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
