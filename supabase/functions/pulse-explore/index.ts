...
Deno.serve(async (req: Request) => {
  ...
  // change and every "Load more". With Explorer as the default post-login
  // page that burned a trial's entire search budget in seconds. The metered
  // actions are the ones that cost us money: company profile views,
  // enrichment, Coach, PDF export.
