...
export default function CTABanners() {
  return (
    <section className="grid gap-6 lg:grid-cols-2">
      <a href="/command-center" className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-8 shadow-sm transition hover:shadow">
      ...
      <a href="/rfp" className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-8 shadow-sm transition hover:shadow">
